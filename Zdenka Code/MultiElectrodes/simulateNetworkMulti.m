...
% SimulationOptions - Structure that contains general simulation detafils that are indepedent of
...
function onSwitchMatrix = getOnSubGraph(adjMat, onOrOff,Connectivity)
