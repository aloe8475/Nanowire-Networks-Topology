function [OutputDynamics, SimulationOptions, snapshots] = simulateNetworknewkevin(glo,Connectivity, Components, Stimulus, SimulationOptions, varargin)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%     kk = 1; % Counter
    ...
    for ii = 1 : niterations
        ...
        % Solve equation:
        if 0
        if ii==floor(1/8*(glo.c-glo.t)+glo.t)||ii==floor(2/8*(glo.c-glo.t)+glo.t)||ii==floor(3/8*(glo.c-glo.t)+glo.t)||ii==floor(4/8*(glo.c-glo.t)+glo.t)||ii==floor(5/8*(glo.c-glo.t)+glo.t)||ii==floor(6/8*(glo.c-glo.t)+glo.t)||ii==floor(7/8*(glo.c-glo.t)+glo.t)||ii==floor(8/8*(glo.c-glo.t)+glo.t)
...
%         end
    ...
    OutputDynamics.testcurrent        = testcurrent;
    OutputDynamics.networkResistance         =  abs(Stimulus.Signal(1,:)'./networkCurrent(:,1))
