...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    switch Components.ComponentType
        ...
        case 'atomicSwitch'
            ...
            Components.resetVoltage  = ones(E+1,1)*1e-3;    % (Volt) - when voltage hits this threshold, lamda decreases
            Components.criticalFlux  = ones(E+1,1)*1e-1;    % (Volt*sec) - when lamda is > than this threshold, switch turns on
            Components.maxFlux       = ones(E+1,1)*1.5e-1;  % (Volt*sec)
        case 'resistor'
