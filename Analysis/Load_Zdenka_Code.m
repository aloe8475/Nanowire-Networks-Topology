...
function [network, sim_loaded, explore_network, numNetworks] = Load_Zdenka_Code()
%% Load Network Data:
%choose network to load
computer=getenv('computername');
switch computer
    case 'W4PT80T2'
        dataPath='C:\Users\aloe8475\Documents\PhD\GitHub\CODE\Zdenka''s Code\atomic-switch-network-1.3-beta\examples';
    case ''
