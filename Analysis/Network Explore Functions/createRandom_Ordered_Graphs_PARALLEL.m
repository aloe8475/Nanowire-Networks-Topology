function [randomOrdered, randomOrdered100, Parameters]=createRandom_Ordered_Graphs_PARALLEL(AgNW)
dbstop if error
...
switch computer
    ...
    case '' %if on linux
        savePath='/headnode2/aloe8475/CODE/Analysis/Explore Analysis/Ordered+Random Data/';
...
for graph=1%:50 %bootstrapping
    ...
    for b = 0:0.05:1
        ...
        ws{graph}{2,count} = WattsStrogatz(500,round(mean(full(AgNW.AvgDegree(2)))),b);
