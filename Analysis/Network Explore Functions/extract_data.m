function extract_data(network)
%Training Data:
for simNum = 1:length(network.Simulations)
    ...
    if save_drain=='y'
        save_name=[network.Name SelSims.Settings.Model '_' SelSims.Settings.SigType '_' num2str(length(SelSims)) 'SimsOnly_' num2str(SelSims.Settings.Time) '_Sec_' num2str(numElec) 'Electrodes_Vmax_' num2str(SelSims.Settings.Vmax) '_' network.Simulations{simNum}.Type '_' num2str(simNum) '_' date '_ForPython'];
