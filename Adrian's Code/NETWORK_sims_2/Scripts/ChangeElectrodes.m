function [newtime,electrode]=ChangeElectrodes(electrode,elenumb,settings)
%takes electrodes for a simulation (in electrode table)
%and create new signal accordingly.
...
newtime=t;
electrode.Value{elenumb}=v;
electrode.OpenFlag{elenumb}=open;
